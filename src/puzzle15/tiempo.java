...
public class tiempo extends JPanel implements Runnable{
	...
	public tiempo(){
		...
		nhor.setBounds(85, 30, 30, 30);		
		nmin.setBounds(115, 30, 30, 30);
		nseg.setBounds(145, 30, 30, 30);
		thor.setBounds(85, 60, 30, 30);		
		tmin.setBounds(115, 60, 30, 30);
		tseg.setBounds(145, 60, 30, 30);
		pun1.setBounds(115, 60, 5, 30);
		pun2.setBounds(145, 60, 5, 30);
